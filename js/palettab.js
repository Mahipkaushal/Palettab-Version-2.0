...
var Palettab = (function() {
    ...
    function assignFonts() {
        ...
        if($savedFonts != null) {
            fontLoader.setNextFont($savedFonts);
        ...
        savePalettab.setFont(usedFonts);
    }
    ...
    function main() {
        ...
        // Initialize Save Palettab Module
        savePalettab.init();
